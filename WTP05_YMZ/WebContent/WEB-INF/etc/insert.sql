...
insert into restaurant values(restaurant_no_seq.nextval, '새마을식당', '한식', '031-111-2222', '경기도 성남시 분당구 삼평동', '백주부의 새마을식당이쥬', '11111111111111,11111111111112,11111111111113,11111111111114,', 0, 0, '회식,', '20150530', 0, 10);
