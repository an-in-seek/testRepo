...
<table style="width:100%;margin-bottom:20px;">
	<tr id="top1" style="font-family:monospace;">
		...
		<td align="left" valign="top" style="width:270px;padding:0px;"><img style="width:270px;height:210px;border-style:solid;border-width:5px;border-color:lightgray;" src="${initParam.rootPath }/uploadPhoto/${fn:split(requestScope.top5[0].pictureName,',')[0] }"></td>
...
<table style="width:100%;margin-bottom:20px;">
	<tr align="left">
		<td id="top2" style="width:25%;">2.<br><img style="width:160px;height:120px;" src="${initParam.rootPath }/uploadPhoto/${fn:split(requestScope.top5[1].pictureName,',')[0] }"><br><a href="${initParam.rootPath }/restaurant/restaurantView.do?restaurantNo=${requestScope.top5[1].restaurantNo }&backURL=${initParam.rootPath}/index.do">${requestScope.top5[1].restaurantName }</a><br><font size="2" color="gray">${requestScope.top5[1].category } | ${requestScope.locations[1] }</font></td>
		<td id="top3" style="width:25%;">3.<br><img style="width:160px;height:120px;" src="${initParam.rootPath }/uploadPhoto/${fn:split(requestScope.top5[2].pictureName,',')[0] }"><br><a href="${initParam.rootPath }/restaurant/restaurantView.do?restaurantNo=${requestScope.top5[2].restaurantNo }&backURL=${initParam.rootPath}/index.do">${requestScope.top5[2].restaurantName }</a><br><font size="2" color="gray">${requestScope.top5[2].category } | ${requestScope.locations[2] }</font></td>
		<td id="top4" style="width:25%;">4.<br><img style="width:160px;height:120px;" src="${initParam.rootPath }/uploadPhoto/${fn:split(requestScope.top5[3].pictureName,',')[0] }"><br><a href="${initParam.rootPath }/restaurant/restaurantView.do?restaurantNo=${requestScope.top5[3].restaurantNo }&backURL=${initParam.rootPath}/index.do">${requestScope.top5[3].restaurantName }</a><br><font size="2" color="gray">${requestScope.top5[3].category } | ${requestScope.locations[3] }</font></td>
		<td id="top5" style="width:25%;">5.<br><img style="width:160px;height:120px;" src="${initParam.rootPath }/uploadPhoto/${fn:split(requestScope.top5[4].pictureName,',')[0] }"><br><a href="${initParam.rootPath }/restaurant/restaurantView.do?restaurantNo=${requestScope.top5[4].restaurantNo }&backURL=${initParam.rootPath}/index.do">${requestScope.top5[4].restaurantName }</a><br><font size="2" color="gray">${requestScope.top5[4].category } | ${requestScope.locations[4] }</font></td>
	</tr>
</table>
<hr>
</div>